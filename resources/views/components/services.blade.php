<div id="services" class="mb-10 mt-10">
    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-center text-gray-900 dark:text-white">Our Services</h2>

    <div class="row" style="background-color:#fcfffd;">
        <div class="column ">
            <h2 class="mb-3">
            ...
            <Button>
                <a href="design" class="bg-blue-500 ml-3 rounded-full text-xs font-semibold text-white uppercase py-3 px-5">
                    More Details
                </a>
            </Button>
        </div>
