<x-contentLayout>
    <section class="py-10 2xl:py-10 bg-blueGray-100 rounded-t-10xl overflow-hidden">
        <div class="reviewContainer px-4 mx-auto">
            <h1 class="mt-8 mb-14 md:mb-24 text-5xl md:text-10xl xl:text-11xl font-heading font-medium text-center">All Reviews</h1>
