<x-contentLayout>
    ...
    <section class="mb-8 text-center mt-10 rounded-lg">
        <div class="update">
        ...
        <div class="pfather">
            <ul class="pbaby rounded-lg text-indigo-500 text-left">
                <li>1. Spectrum Field Services</li>
                <li>2. Assurant</li>
                <li>3. Sentinel Field Services</li>
                <li>4. Xome Solutions</li>
                <li>5. Five Brothers Property Preservation Company</li>
                <li>6. Mortgage Contracting Services (MCS)</li>
                <li>7. Mortgage Specialists International (MSI)</li>
            </ul>
            <ul class="pbaby rounded-lg text-indigo-500 text-left">
                <li>8. US Best Repairs</li>
                <li>9. A2Z Field Services.</li>
                <li>10. Safeguard Properties</li>
                <li>11. Cyprexx Services</li>
                <li>12. Altisource</li>
    ...
    <section class="lastPart mb-6 rounded-lg">
        <h1 class="text-4xl tracking-tight text-center text-gray-900 dark:text-white mb-6 mt-8">
            National Preservation Companies That Provide Mostly REO Work
        </h1>
        <h3 class="text-xl tracking-tight text-center text-gray-900 dark:text-white mb-8">
        ...
        <div class="pfather">
            <ul class="pbaby rounded-lg text-indigo-500 text-left">
                <li>1. Cyprexx </li>
                <li>2. Spectrum Field Services</li>
                <li>3. SingleSource Property Solutions </li>
                <li>4. IMS</li>
                <li>5. PK Management </li>
                <li>6. Guardian Asset Management</li>
            </ul>
            <ul class="pbaby rounded-lg text-indigo-500 text-left">
                <li>7. ABBA Construction</li>
                <li>8. Homeshield Solutions </li>
                <li>9. A2Z Field Services </li>
                <li>10. GTJ P&M </li>
