<x-contentLayout>
    ...
    <section class="mb-6">
        <h1>
            We are Offering 5 Types of Web Development Services !!
        </h1>
        <br />
        <ul>
            <li>
